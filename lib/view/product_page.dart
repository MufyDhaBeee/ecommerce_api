    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          final productDetailsData = snapshot.data;
          if (!snapshot.hasData) {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Text(
                          productDetailsData!.category.toString(),
                            style: TextStyle(
                              fontSize: 12,
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      Text(
                      '(${productDetailsData.rating?.rate})',
                        style: TextStyle(
                          fontSize: 14,
                      ...
                      SizedBox(width: 5),
                      Text(
                        '(${productDetailsData.rating?.count} reviews)',
                      //  '(1,240 reviews)',
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w400,
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              SizedBox(height: 4,),
                              Text('\$${productDetailsData.price}', style: TextStyle(
                                color: Color.fromRGBO(10, 27, 62, 1),
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                              ),),
                  ...
                  SizedBox(height: 5,),
                  Text(productDetailsData.description, style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w400,
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            SizedBox(height: 10,),
                            Text('${productDetailsData.rating?.rate}', style: TextStyle(
                              fontSize: 32,
                              fontWeight: FontWeight.bold,
